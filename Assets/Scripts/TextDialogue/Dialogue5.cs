    ...
    void Update()
    {
        ...
        if (text != null)
        {
            if (Input.GetKeyDown(KeyCode.Space))
            {
                ...
                if (text == "Wait wai- I'm not talking about that anymore... Just take me with you. I can glide through the sky and help you reach places you've never been before.")
                {
                    RenderTwo.sprite = PetraEmberrased;
                }
